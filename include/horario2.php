        ...
        <table class="modulos__diurno__contenido__tabla">
          ...
          <tbody class="modulos__diurno__contenido__tabla__cuerpo">
            <tr>
              ...
              <td style="background-color:#C2F2F2" rowspan="3">Adm. Base de Datos<br><b>Prof: M Perez.</b> <br>Lab: 01</td>
              <td style="background-color:#E9EFF2" rowspan="4">Arq. Soluciones Web<br><b>Prof: L Chavez</b><br>Lab: 01</td>
              <td style="background-color:#E9EFF2" rowspan="4">Arq. Soluciones Web<br><b>Prof: L Chavez</b><br>Lab: 01</td>
              <td style="background-color:#367FBF" rowspan="3">Integracion y Testeo<br><b>Prof: M Perez</b><br>Lab: 01</td>
              <td style="background-color:#1A80D9" rowspan="3">Desarrollo Web<br><b>Prof: E Huaylinos</b><br>Lab: 01</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td style="background-color:#13c5dd" rowspan="1">Diseño de Software<br><b>Prof: A Padillo</b><br>Lab: 01</td>
              <td style="background-color:#1A80D9" rowspan="3">Desarrollo Web<br><b>Prof: E Huaylinos</b><br>Lab: 01</td>
              <td style="background-color:#4047C2" rowspan="3">Investigación e<br>Innovación<br><b>Prof: V Calderon</b><br>Lab: 01</td>
            </tr>
            <tr>
              <td class="numero">5</td>
              <td class="numero">11:15 - 12:00</td>
              <td rowspan="2" style="background-color:#1A80D9">Desarrollo Web<br><b>Prof: E Huaylinos</b><br>Lab: 01</td>
              <td style="background-color:#C2F2F2" rowspan="2">Adm. Base de Datos<br><b>Prof: M Perez.</b><br>Lab: 01</td>
              <td style="background-color:#074073" rowspan="2">Diseño de Software<br><b>Prof: A Padillo</b><br>Lab: 01</td>
            </tr>
            <tr>
        ...
        <table class="modulos__diurno__contenido__tabla">
          ...
          <tbody class="modulos__diurno__contenido__tabla__cuerpo">
            <tr>
              ...
              <td style="background-color:#E9EFF2" rowspan="6">Arquitectura<br>Soluciones Web<br><b>Prof: R. Fernández</b><br>Lab: 01</td>
              <td style="background-color:#367FBF" rowspan="3">Integracion y Testeo<br><b>Prof: M Perez</b><br>Lab: 01</td>
              <td style="background-color:#C2F2F2" rowspan="2">Adm. Base de Datos<br><b>Prof: L Chavez</b><br>Lab: 01</td>
              <td style="background-color:#1A80D9" rowspan="4">Desarrollo Web<br><b>Prof: E Huaylinos</b><br>Lab: 01</td>
              <td style="background-color:#4047C2" rowspan="3">Investigación e<br>Innovación<br><b>Prof: V Calderon</b><br>Lab: 01</td>
            </tr>
            <tr>
              <td class="numero">2</td>
            ...
            <tr>
              ...
              <td style="background-color:#C2F2F2" rowspan="3">Adm. Base de Datos<br><b>Prof: L Chavez</b><br>Lab: 01</td>
             <td style="background-color:#074073" rowspan="3">Diseño de Software<br><b>Prof: A Padillo</b><br>Lab: 01</td>
            </tr>
            <tr>
              <td class="numero">5</td>
              <td class="numero">05:00 - 05:45</td>
              <td style="background-color:#E9EFF2" rowspan="2">Arquitectura<br>Soluciones Web<br><b>Prof: R Fernández</b><br>Lab: 01</td>
            </tr>
            <tr>
              <td class="numero">6</td>
